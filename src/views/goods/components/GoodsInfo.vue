  ...
  <div class="form_center">
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="商品分类" prop="productCategoryId">
        <el-select v-model="form.productCategoryId" placeholder="请选择分类">
          <el-option
